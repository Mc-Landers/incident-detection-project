...
from fonctions.crisis_graphs.compute_graphs_variables_par_variables import *
from fonctions.crisis_graphs.mise_en_forme_variables_par_variables import *
...
#Creation de graphiques variables par période de temps
    panel_graphique_variables_par_variables = graphs_variables_par_variables_crise(df_total, df_crisis, unique_values, variable_textuelle, n, t, c = 1, crisis_column = 'Gravité', date = "whole")
    schema_variables = create_schema(panel_graphique_variables_par_variables, unique_values, variable_textuelle)
    save_graphs_variable_par_variable(schema_variables,n,t,w,a,contact,info,sujet,solution,types)