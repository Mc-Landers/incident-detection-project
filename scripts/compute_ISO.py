...
from fonctions.isolation_forest.compute_isolation_forest import *
from fonctions.metrics.save_metrics import *
from fonctions.isolation_forest.save_predictions_ISO import *
...
if __name__ == '__main__':
    ...
    #Compute de Isolation forest
    df_iso ,precision, recall, f1_score, f1_score_Arthur = compute_isolation_forest(df_total,unique_values,variable_textuelle)
    save_prediction_ISO(df_iso,n,t,w,a, contact,info, sujet, solution, types)
    tableau_metrics = compute_dataframe_metrics('Isolation_Forest',precision, recall, f1_score, f1_score_Arthur)
    save_metrics(tableau_metrics,'ISO',n,t,w,a,contact, info, sujet, solution, types)
