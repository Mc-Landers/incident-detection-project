...
from fonctions.crisis_graphs.compute_graphs_total import *
from fonctions.crisis_graphs.save_graphs import *
from fonctions.crisis_graphs.compute_graphs_variables import *
from fonctions.crisis_graphs.mise_en_forme_variables import *
from fonctions.crisis_graphs.mise_en_forme_graph_total import*
...
#Creation de graphiques possedant toutes les valeurs    
    panel_graphique,crisis_unique_date = graphs_variables_totales_crise(df_total, df_crisis, unique_values,variable_textuelle, n, t, c = 1, crisis_column = 'Gravité', date = "whole")
    schema_totaux = schema_totaux(panel_graphique)
    save_graphs_total(schema_totaux,n,t,w,a,contact,info,sujet,solution,types)

#Creation de graphiques variables par période de temps    
    panel_graphique_variable,crisis_unique_date = graphs_variables_crise(df_total, df_crisis, unique_values,variable_textuelle, n, t, c = 1, crisis_column = 'Gravité', date = "whole")
    schema = create_schema_format(panel_graphique_variable, crisis_unique_date)
    save_graphs_variable(schema,n,t,w,a,contact,info,sujet,solution,types)