...
from fonctions.nb_df.save_df import get_data, get_unique_values, get_variable_textuelle
from fonctions.random_algo.compute_random_algorithm import *
from fonctions.metrics.save_metrics import *
from fonctions.random_algo.save_prediction_random import *
...
from fonctions.random_algo.compute_random_colonnes import *
...
if __name__ == '__main__':
    ...
    #Compute de Random_algorithm
    df_total = compute_random_colonnes(df_total)
    for r in range(10,100,10):
        df_rand, precision, recall, f1_score, f1_score_Arthur = compute_random_algorithm(df_total,r)
        save_prediction_random(df_rand, f"{r}",n,t,w,a, contact, info, sujet, solution, types)
        tableau_metrics = compute_dataframe_metrics(f'rand_{r}',precision, recall, f1_score, f1_score_Arthur)
        save_metrics(tableau_metrics,f"{r}",n,t,w,a,contact, info, sujet, solution, types)
